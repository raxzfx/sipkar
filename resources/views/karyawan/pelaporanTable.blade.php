...
<div class="container-xxl flex-grow-1 container-p-y">
   ...
   <div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">Tabel Pelaporan Saya</h5>
        <a href="{{ route('karyawan.pelaporanAdd') }}" class="btn btn-primary btn-sm">Add Data</a>
    </div>
          ...
          <tr>
            ...
            <td>
              ...
              @elseif ($laporan->status === 'pending')
                menunggu review
              @else
                <a href="{{ route('karyawan.pelaporanEdit', $laporan->id_pelaporan) }}" class="btn btn-sm btn-primary">
                  <i> edit lampiran </i>
                </a>
              @endif
            </td>
...
<div class="card mt-4">
  <div class="card-header d-flex justify-content-between align-items-center">
    <h5 class="mb-0">Histori Laporan Saya</h5>
  </div>
  <div class="table-responsive text-nowrap">
    <table class="table  table-hover">
      ...
      <tbody>
        @forelse ($historiPelaporans as $index => $histori)
          <tr>
            ...
            <td>{{ $histori->pelaporan->user->nama_lengkap ?? '-' }}</td>
