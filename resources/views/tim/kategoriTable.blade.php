...
<div class="container-xxl flex-grow-1 container-p-y">
   ...
   <div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('tim.kategoriAdd') }}" class="btn btn-primary btn-sm">Add Data</a>
      </div>
            ...
            <td>
              <div class="dropdown">
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item" href="{{route('tim.kategoriEdit', $kategori->id_kategori_penilaian)}}">
                      <i class="icon-base bx bx-edit-alt me-1"></i> Edit
                  </a>
                  <form action="{{ route('tim.kategoriDelete',  $kategori->id_kategori_penilaian) }}" method="POST" class="d-inline delete-form">
                    @csrf
                    @method('DELETE')
