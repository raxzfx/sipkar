...
<div class="container-xxl flex-grow-1 container-p-y">
   ...
   <div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('admin.penilaianAdd') }}" class="btn btn-primary btn-sm">Add Data</a>
      </div>
            ...
            <td>
              <div class="dropdown">
                ...
                <div class="dropdown-menu">
                  <form action="{{ route('admin.penilaianDelete',  $nilai->id_nilai) }}" method="POST" class="d-inline delete-form">
                    @csrf
                    @method('DELETE')
