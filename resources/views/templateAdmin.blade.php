  ...
  <body>
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo mb-5">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">SIPKAR</span>
            </a>
            ...
            <footer class="content-footer footer bg-footer-theme">
              <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                <div class="mb-2 mb-md-0">
                  ...
                  , made with ❤️ by
                  <a href="https://themeselection.com" target="_blank" class="footer-link fw-bolder">Rasya Nazraditya</a>
                </div>
                <div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
          // Dapatkan path URL saat ini (hilangkan trailing slash)
          const currentPath = window.location.pathname.replace(/\/$/, "");
          
          // Debug: Tampilkan path saat ini di console
          console.log("Current path:", currentPath);
          
          // Temukan semua menu link
          const menuLinks = document.querySelectorAll('.menu-link:not(.menu-toggle)');
          
          // Debug: Tampilkan semua menu links
          ...
          menuLinks.forEach(link => {
            ...
            // Debug: Tampilkan href yang sedang diproses
            console.log("Checking link:", href);
            
            // Normalisasi href (hilangkan domain jika ada dan trailing slash)
            let normalizedHref = href;
            try {
              normalizedHref = new URL(href).pathname.replace(/\/$/, "");
            } catch (e) {
              normalizedHref = href.replace(/^https?:\/\/[^\/]+/, "").replace(/\/$/, "");
            }
            
            // Debug: Tampilkan href yang dinormalisasi
            ...
            if (normalizedHref && (currentPath === normalizedHref || currentPath.startsWith(normalizedHref + '/'))) {
              // Debug: Tampilkan kecocokan yang ditemukan
              console.log("Match found for:", normalizedHref);
              
              // Tambahkan class active ke parent li
              link.closest('.menu-item').classList.add('active');
              
              // Jika ada submenu, buka parent menu-nya
          ...
          // Handle khusus untuk menu toggle
          const menuToggles = document.querySelectorAll('.menu-toggle');
          menuToggles.forEach(toggle => {
            const parentItem = toggle.closest('.menu-item');
            if (parentItem.querySelector('.menu-sub .active')) {
